        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsMakeUpLecture = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimeRange = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_StudentId_CourseId_Date_MarkedByTeacherId",
                table: "Attendances",
                columns: new[] { "StudentId", "CourseId", "Date", "MarkedByTeacherId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TeacherAssignments_TeacherId_CourseId",
                table: "TeacherAssignments",
                columns: new[] { "TeacherId", "CourseId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TimetableSlots_CourseId_DayOfWeek_TimeRange",
                table: "TimetableSlots",
                columns: new[] { "CourseId", "DayOfWeek", "TimeRange" },
                unique: true,
                filter: "[TimeRange] IS NOT NULL");
        }
